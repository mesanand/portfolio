...
- **SGA SOG Board:** replaces the "Student Government Governance Board" entry (same role): Secretary, Sep 2024 to Feb 2025, "Reviewed constitutions and bylaws for 500+ organizations under the director of student involvement. Took meeting notes and organized information for several members of the board."
- **Logos on the four current leadership cards** (overrides prompt 7's "no logos for organizations"): Claude Builders Club (claudeneu.com favicon), ACM (the national ACM mark; the chapter has only a text wordmark), Rev (rev.school logo), NIBG (its LinkedIn logo). In `src/assets/logos/`, centered in the space right of each card's heading.
...
- **Hero tagline** (also the footer bio): "Working AI in Private Equity. School club enthusiast. I ship pipelines by day and communities by night."
